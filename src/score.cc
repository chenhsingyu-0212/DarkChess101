...
double score::getDynamicScore(int P, int C, int N, int R, int M, int G, int K,
  ...
  switch (chessType) {
    case 0:
      return this->scoreLevel[6] + P * 10;
      break;
    case 1:
      return this->scoreLevel[5] + P * 10 + C * 200 + N * 15 + R * 40 + M * 9 +
             G * 270 + K * 600;
      break;
    case 2:
      return this->scoreLevel[4] + P * 10 + C * 200 + N * 15;
      break;
    case 3:
      return this->scoreLevel[3] + P * 10 + C * 200 + N * 15 + R * 40;
      break;
    case 4:
      return this->scoreLevel[2] + P * 10 + C * 200 + N * 15 + R * 40 + M * 90;
      break;
    case 5:
      ...
      break;
    case 6:
      return this->scoreLevel[0] + C * 200 + N * 15 + R * 40 + M * 90 +
             G * 270 + K * 600;
      break;
  }
}
